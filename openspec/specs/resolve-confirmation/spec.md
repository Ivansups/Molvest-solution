...
Operator confirmation before a conversation becomes resolved: a yes/no
modal with an optional comment, stored on the conversation and never sent
to the guest or posted to Bitrix/Redmine.
