...
### Requirement: No public conversation API in this change

The system SHALL NOT expose HTTP routes for listing, creating, or updating conversations, messages, or escalations as part of this change. `POST /chat` SHALL keep its current behavior and SHALL NOT be required to write these tables yet.
