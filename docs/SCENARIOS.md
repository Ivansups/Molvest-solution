...
3. Отдельно: после `resolve` эскалированного диалога успешные кейсы попадают в базу автоматически ("обучение на кейсах", `app/services/case_learning.py`) — правила + малая LLM (OpenRouter GOOD/BAD) отбирают пару «вопрос — автоответ», тот же пайплайн чанкинга/эмбеддинга, но источник — `conversations`, а не ручная загрузка.
